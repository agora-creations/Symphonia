...
export function frontmatterToTask(
  ...
  return {
    ...
    sourceMilestone: asString(fm.source_milestone) || undefined,
    sourcePlan: asString(fm.source_plan) || undefined,
    sourceRequirements: asString(fm.source_requirements) || undefined,
    sourceDiscussion: asString(fm.source_discussion) || undefined,
    sourceDecisions: asStringArray(fm.source_decisions),
    generatedBy: asString(fm.generated_by) || undefined,
    generationId: asString(fm.generation_id) || undefined,
    proposalItemId: asString(fm.proposal_item_id) || undefined,
    dependsOn: asStringArray(fm.depends_on),
    reviewExpectations: asStringArray(fm.review_expectations),
