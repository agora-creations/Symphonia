  ...
  return (
    <article
      className={[
        ...
        featured
          ? "border-[var(--landing-orange)] bg-[var(--landing-cream)]"
    ...
    >
      <div className="flex items-start justify-between gap-4">
        ...
        {featured && (
          <span className="rounded-full bg-[var(--landing-orange)] px-3 py-1 text-[12px] font-semibold text-white">
            Best fit
          </span>
        )}
      </div>
      ...
      <Link
        href="/dashboard"
        className="mt-8 inline-flex h-11 items-center justify-center rounded-full bg-[var(--landing-ink)] px-5 text-[15px] font-semibold text-white transition hover:bg-[var(--landing-orange-dark)]"
      >
        Connect repository
      </Link>
    </article>
